...
config :inmana, Inmana.Repo,
  migration_primary_key: [type: :binary_id], # uuid
  migration_foreign_key: [type: :binary_id]

# Configures the endpoint
config :inmana, InmanaWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "O6OoXioVash8cAwcp1G1QfWPDiFN/O/izXEDsGTXh25P4UgG62NxVDXT+fZVRcqC",
  render_errors: [view: InmanaWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Inmana.PubSub,
  live_view: [signing_salt: "OPyRob6G"]
